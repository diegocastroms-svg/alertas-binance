# main_curto_v3.2.py
# ✅ Corrigido: shortlist e filtro USDT
# ✅ Mantido: intrabar ativo, alertas 5m/15m
# ✅ Nada além do necessário foi alterado
...
async def main_loop():
    async with aiohttp.ClientSession() as session:
        ...
        total = len(symbols)
        await send_msg(session, f"✅ v3.intrabar ativo | {total} pares SPOT | cooldown 15m | {nowbr()} 🇧🇷")
...
@app.route("/")
def home():
    return "Binance Alertas v3.2 ativo", 200
